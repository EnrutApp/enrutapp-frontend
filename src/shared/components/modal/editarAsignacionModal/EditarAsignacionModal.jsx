...
const conductorSchema = Yup.object().shape({
    ...
    idVehiculo: Yup.string().required('El vehículo es requerido')
});

const EditarAsignacionModal = ({ isOpen, onClose, onConfirm, reserva }) => {
    ...
    const formik = useFormik({
        ...
        validationSchema: conductorSchema || undefined,
        ...
        onSubmit: async (values) => {
            try {
                ...
                const asignacion = {
                    idConductor: parseInt(values.idConductor),
                    nombreConductor: conductorSeleccionado?.nombre || 'No disponible',
                    idVehiculo: parseInt(values.idVehiculo),
                    placaVehiculo: vehiculoSeleccionado?.placa || 'No disponible'
                };
                ...
                setSubmitError(err.message || 'Error al actualizar asignación');
            }
        }
    });
            ...
            <main className="p-6 list-enter max-h-[90vh] overflow-y-auto scrollbar-hide rounded-xl shadow-lg">
                ...
                <div className="px-4">
                    <div className="leading-tight mb-6">
                        <h2 className="h3 font-medium text-primary">Editar asignación conductor</h2>
                    ...
                    <form onSubmit={formik.handleSubmit}>
                        ...
                        <div className="flex justify-center gap-3 mt-6">
                            ...
                            >
                                {formik.isSubmitting ? 'Actualizando...' : 'Editar'}
                            </md-filled-button>
                        </div>
                    </form>
                </div>
