  ...
  const cargarDatos = async () => {
    try {
      ...
      try {
        ...
        setClientes(
          clientesData && clientesData.length > 0 ? clientesData : MOCK_CLIENTES
        );
      } catch (err) {
      ...
      try {
        ...
        setUbicaciones(
          ubicacionesData && ubicacionesData.length > 0
            ? ubicacionesData
            : MOCK_UBICACIONES
        );
      } catch (err) {
      ...
      try {
        ...
        const conductoresData = todosUsuarios.filter(
          u => u.rol && u.rol.toLowerCase() === 'conductor'
        );
                  ...
                  <div className="flex gap-2">
                    <div className="flex-1">
                      <input
                        ...
                        value={
                          conductorAsignado
                            ? `${conductorAsignado.nombre} ${conductorAsignado.placaVehiculo ? `(${conductorAsignado.placaVehiculo})` : ''}`
                            : ''
                        }
                        readOnly
