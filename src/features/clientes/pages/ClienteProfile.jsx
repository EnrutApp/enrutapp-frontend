...
const ClienteProfile = ({ cliente, isOpen, onClose }) => {
        ...
        <div className={`flex flex-col gap-4 overflow-auto ${isClosing ? 'profile-exit' : 'profile-enter'}`}
            ...
            <div className='flex justify-between items-center'>
                <div className='flex items-center gap-1'>
                    ...
                    <h2 className='h4 font-medium text-primary'>Cliente</h2>
                </div>
            ...
            <div className='bg-primary text-on-primary content-box-small'>
                <h1 className='h3 text-on-primary'>{cliente.nombre}</h1>
                <span className='subtitle1 font-medium text-on-primary'>{cliente.documento}</span>
            </div>

            <div className="flex flex-col gap-3 flex-1">
                <div className="flex flex-col">
                    <div className="content-box-outline-3-small">
                        <span className="subtitle1 text-primary font-light">Estado del cliente</span>
                        <div className='flex mt-1'>
                            <button className={`btn font-medium btn-lg flex items-center ${cliente.estado === 'Activo' ? 'btn-primary' : 'btn-secondary'}`}>
                                {cliente.estado}
                            </button>
                        </div>
                    </div>
