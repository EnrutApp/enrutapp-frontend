                            ...
                            <div className="flex flex-col gap-8 list-enter min-h-[300px] justify-center">
                                <div className="text-center space-y-4">
                                    <div className="w-20 h-20 bg-fill rounded-full flex items-center justify-center mx-auto">
                                        <md-icon className="text-3xl text-blue">directions_car</md-icon>
                                    </div>
                                    ...
                                    <div className="select-wrapper w-full">
                                        ...
                                        <Controller
                                            ...
                                            render={({ field }) => (
                                                <select
                                                    {...field}
                                                    className={`select-filter w-full px-4 input bg-fill border rounded-lg text-primary focus:outline-none focus:border-primary transition-colors ${errors.idCategoriaLicencia ? 'border-red-500' : 'border-border'
                                                        }`}
                                                ...
                                                >
                                                    ...
                                                    {categorias.map((categoria) => (
                                                        ...
                                                        >
                                                            {categoria.nombreCategoria} - {categoria.descripcion}
                                                        </option>
                                                    ))}
                                                </select>
                                            )}
                                    ...
                                    <Controller
                                        ...
                                        render={({ field }) => (
                                            <input
                                                type="date"
                                                {...field}
                                                className={`w-full px-4 py-3 input bg-fill border border-border rounded-lg text-secondary focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all date-secondary ${errors.fechaVencimientoLicencia ? 'border-red-500' : 'border-border'
                                                    }`}
                                            />
                                        )}
                                    />
                                    ...
                                    <Controller
                                        ...
                                        render={({ field }) => (
                                            <textarea
                                                ...
                                                className={`w-full px-4 py-3 input bg-fill border rounded-lg text-primary placeholder-text-secondary focus:outline-none focus:border-primary transition-colors resize-none ${errors.observaciones ? 'border-red-500' : 'border-border'
                                                    }`}
                                            />
                                        )}
                                    />
