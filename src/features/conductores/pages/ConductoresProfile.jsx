    ...
    >
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-1">
          ...
          <h2 className="h4 font-medium text-primary">Conductor</h2>
        </div>
        ...
        <div className="flex flex-col">
          <div className="content-box-outline-3-small">
            ...
            <div className="flex mt-1">
              <button
                className={`btn font-medium btn-lg flex items-center ${conductor.estado === 'Activo' ? 'btn-primary' : 'btn-secondary'}`}
              >
                {conductor.estado}
              </button>
            </div>
