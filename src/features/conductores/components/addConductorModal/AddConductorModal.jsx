...
export default function AddConductorModal({ isOpen, onClose, onConfirm, onSubmitConductor }) {
    ...
    // 🔥 NUEVO: Resetear todo cuando se cierra el modal
    useEffect(() => {
        if (!isOpen) {
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        {currentStep === 2 && (
                            <div className='grid grid-cols-2 gap-4 mb-4'>
                                <div className='flex flex-col gap-1'>
                                    <label className='subtitle1 text-secondary'>Nombre <span className='text-red'>*</span></label>
                                    <input
                                        name='nombre'
                                        value={form.nombre}
                                ...
                                <div className='flex flex-col gap-1'>
                                    <label className='subtitle1 text-secondary'>Apellido <span className='text-red'>*</span></label>
                                    <input
                                        name='apellido'
                                        value={form.apellido}
                                        onChange={handleChange}
                                ...
                                <div className='flex flex-col gap-1'>
                                    <label className='subtitle1 text-secondary'>Cédula <span className='text-red'>*</span></label>
                                    <input
                                        name='cedula'
                                        value={form.cedula}
                                        onChange={handleChange}
                                ...
                                <div className='flex flex-col gap-1'>
                                    <label className='subtitle1 text-secondary'>Teléfono <span className='text-red'>*</span></label>
                                    <input
                                        name='telefono'
                                        value={form.telefono}
                                        onChange={handleChange}
                                ...
                                <div className='flex flex-col gap-1'>
                                    <label className='subtitle1 text-secondary'>Licencia <span className='text-red'>*</span></label>
                                    <input
                                        name='licencia'
                                        value={form.licencia}
                                        onChange={handleChange}
                                ...
                                <div className='bg-fill rounded-lg p-4 border border-border'>
                                    ...
                                    <div className='grid grid-cols-2 gap-3'>
                                        <div className='flex flex-col'>
                                            <span className='text-xs text-secondary uppercase font-medium'>Nombre</span>
                                            <span className='text-sm text-primary font-semibold'>{form.nombre || '-'}</span>
                                        </div>
                                        <div className='flex flex-col'>
                                            <span className='text-xs text-secondary uppercase font-medium'>Apellido</span>
                                            <span className='text-sm text-primary font-semibold'>{form.apellido || '-'}</span>
                                        </div>
                                        <div className='flex flex-col'>
                                            <span className='text-xs text-secondary uppercase font-medium'>Cédula</span>
                                            <span className='text-sm text-primary font-semibold'>{form.cedula || '-'}</span>
                                        </div>
                                        <div className='flex flex-col'>
                                            <span className='text-xs text-secondary uppercase font-medium'>Teléfono</span>
                                            <span className='text-sm text-primary font-semibold'>{form.telefono || '-'}</span>
                                        </div>
                                        <div className='flex flex-col'>
                                            <span className='text-xs text-secondary uppercase font-medium'>Licencia</span>
                                            <span className='text-sm text-primary font-semibold'>{form.licencia || '-'}</span>
                                        </div>
                                        {form.correo && (
                                            <div className='flex flex-col'>
                                                <span className='text-xs text-secondary uppercase font-medium'>Correo</span>
                                                <span className='text-sm text-primary font-semibold'>{form.correo}</span>
                                            </div>
                                        )}
                                    </div>
                                </div>
                        ...
                        {success && (
                            <div className='text-green mb-4 text-center'>
                                ...
                                <p className='font-semibold'>¡Conductor agregado correctamente!</p>
                            </div>
                        )}
                        ...
                        <div className='flex justify-between gap-3 mt-6'>
                            ...
                            <div className='flex gap-3'>
                                ...
                                {currentStep < 3 ? (
                                    ...
                                    >
                                        {loading ? 'Agregando...' : success ? 'Agregado ✓' : 'Agregar conductor'}
