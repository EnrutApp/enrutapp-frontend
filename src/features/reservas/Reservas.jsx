                    ...
                    <div className='list-enter'>
                        ...
                        <div className='flex justify-between items-center mt-6 mb-4'>
                            <span className='text-sm text-secondary'>
                                Mostrando {startIndex + 1}-{Math.min(startIndex + 3, totalItems)} de {totalItems} reservas
                            </span>
                            {showPagination && (
                            ...
                            {currentReservas.map((reserva, index) => (
                                ...
                                >
                                    <div className='flex justify-between items-center'>
                                        <div>
                                            <div className='flex flex-col'>
                                                <span>{reserva.fecha}, {reserva.hora} | {reserva.vehiculo}</span>
                                            ...
                                            <div className='flex gap-1'>
                                                ...
                                                <button className={`btn font-medium btn-lg flex items-center ${reserva.estado === 'Pendiente' ? 'btn-yellow' : reserva.estado === 'Completado' ? 'btn-green' : 'btn-secondary'}`}>
                                                    <md-icon slot="edit" className="text-lg">error</md-icon>
                                                    {reserva.estado}
                                                </button>
                                            </div>
                                        </div>
