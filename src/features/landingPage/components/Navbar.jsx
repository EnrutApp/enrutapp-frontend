  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <span
          className={`font-bold tracking-tight text-white leading-none whitespace-nowrap transition-all duration-800 ease-[cubic-bezier(0.25,0.8,0.25,1)] ${scrolled ? 'text-lg opacity-100' : 'text-xl md:text-2xl'}`}
        >
          EnrutApp
        </span>
      </div>
      ...
      <div
        className={`hidden md:flex items-center transition-all duration-800 ease-[cubic-bezier(0.25,0.8,0.25,1)] ${scrolled ? 'opacity-100 translate-y-0' : 'opacity-100'}`}
      >
      ...
      >
        <span className="relative z-10">
          {scrolled ? 'Entrar' : 'Iniciar sesión'}
        </span>
