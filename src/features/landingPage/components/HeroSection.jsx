                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="relative group/input">
                      <input
                        ...
                        className={`w-full px-4 py-3 input bg-fill border rounded-lg text-primary placeholder-text-secondary date-secondary focus:outline-none focus:border-primary transition-colors ${
            ...
            <div className="lg:col-span-7 text-primary space-y-8 lg:pl-16">
              <div className="space-y-4">
                ...
                <h1 className="text-h1 font-bold leading-tight tracking-tight text-primary">
                  Viajar está a un
                  <br />
                  <span className="text-primary">Clic de distancia</span>
                </h1>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4">
                {[
                  ...
                  <div
                    key={i}
                    className="group flex flex-col items-start gap-2 bg-fill p-5 rounded-2xl border border-border transition-all duration-300 hover:border-primary"
                  >
                    <div className="p-2 rounded-lg bg-background text-primary transition-colors">
                      <md-icon>{feature.icon}</md-icon>
                    </div>
                    <div>
                      <h4 className="font-bold text-primary text-body1">
                        {feature.title}
                      </h4>
