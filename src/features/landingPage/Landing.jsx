...
const DestinosCarousel = ({ setFormData, scrollToSection }) => {
  ...
  const destinos = [
    ...
    { nombre: "Quibdó", imagen: "https://caracoltv.brightspotcdn.com/dims4/default/6ab8243/2147483647/strip/true/crop/1890x992+0+65/resize/1200x630!/quality/90/?url=http:%2F%2Fcaracol-brightspot.s3.amazonaws.com%2Fae%2F79%2F52ccc5f9410bac9b20ea23a471ef%2F01-choco-viajeros-por-naturaleza-copy.jpg", rutas: "25+ rutas", descripcion: "Naturaleza y cultura chocoana" },
    { nombre: "Raspadura", imagen: "https://i.ytimg.com/vi/5wW_Rt5UFi8/maxresdefault.jpg", rutas: "15+ rutas", descripcion: "Pueblo tranquilo del Chocó" },
    { nombre: "Bagadó", imagen: "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgE5ov2suelssNCq7T33_brxUFR10eKNJc2YP3MGHsniai1qeyn7eWUnTYSVckSvCYBJTXSq-KCJ93TqGaSP5JFGCqfIXeIiJUtu_p29PZYCi_S1oM3Vw5hqnqVglqpaiXG-JROXAAwTEvSUCeeCY1AVoKdbiNn6WP_cqWUkRG2nFwJniRGFkjDuVc26g/s1000/Municipio%20de%20Bagado.jpg", rutas: "12+ rutas", descripcion: "Riqueza cultural y natural" },
    { nombre: "Lloró", imagen: "https://choco7dias.com/wp-content/uploads/2021/06/lloro-choco-aereo.jpg", rutas: "10+ rutas", descripcion: "El lugar más lluvioso de Colombia" },
    { nombre: "Pereira", imagen: "https://www.colombiaespasion.com/wp-content/uploads/2023/07/Skyline_Pereira-990x557.jpg", rutas: "45+ rutas", descripcion: "La perla del Eje Cafetero" },
    { nombre: "Condoto", imagen: "https://www.diccionariodecolombia.expert/wp-content/uploads/2020/08/condotof.jpg", rutas: "18+ rutas", descripcion: "Tradición minera del Chocó" },
    { nombre: "Istmina", imagen: "https://centralpdet.renovacionterritorio.gov.co/wp-content/uploads/2022/04/itsmina_municipio-choco-1024x651.jpg", rutas: "20+ rutas", descripcion: "Corazón del San Juan" },
    { nombre: "Tadó", imagen: "https://tse2.mm.bing.net/th/id/OIP.zgefMwO7PfBpKHThJPBm8wHaEJ?rs=1&pid=ImgDetMain&o=7&rm=3", rutas: "14+ rutas", descripcion: "Pueblo encantador chocoano" },
    { nombre: "Yuto", imagen: "https://tse2.mm.bing.net/th/id/OIP.O_jtsUY4RiVAp4JZrdOE9wHaDo?rs=1&pid=ImgDetMain&o=7&rm=3", rutas: "8+ rutas", descripcion: "Naturaleza virgen del Pacífico" },
    { nombre: "Cali", imagen: "https://destincolombia.com/wp-content/uploads/2018/08/vida-diurna-y-nocturna-en-cali.jpg", rutas: "60+ rutas", descripcion: "Capital mundial de la salsa" },
  ];
          ...
          {destinos.map((destino, idx) => (
            ...
            >
              <div className="relative h-72 overflow-hidden">
                <img src={destino.imagen} alt={destino.nombre} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
...
const LandingPage = () => {
  ...
  // valida si la fecha es pasada (compara solo fecha)
  ...
  const handleBuscar = (e) => {
    ...
    if (!formData.origen.trim()) newErrors.origen = "Debes indicar la ciudad de origen";
    if (!formData.destino.trim()) newErrors.destino = "Debes indicar la ciudad de destino";
    if (formData.origen.trim() && formData.destino.trim() && formData.origen.trim().toLowerCase() === formData.destino.trim().toLowerCase()) {
    ...
    else if (isPastDate(formData.fecha)) newErrors.fecha = "No puedes seleccionar una fecha pasada";

    setErrors(newErrors);

    if (Object.keys(newErrors).length > 0) {
      // focus al primer error - opcional
      return;
    }

    // Navegar a la página de resultados con los datos de búsqueda
...
>
  ...
  <ul className={`hidden md:flex space-x-8 text-sm font-medium transition-colors duration-300 ${scrolled ? "text-gray-700" : "text-white"}`}>
          ...
          <div className="grid md:grid-cols-5 gap-8 items-center">
            <div className="md:col-span-2">
              <div className="bg-white rounded-xl shadow-2xl p-6">
                ...
                <form className="space-y-4" onSubmit={handleBuscar} noValidate>
                  ...
                  <div>
                    <label className="text-xs font-semibold text-gray-700 mb-1.5 block uppercase tracking-wide">Origen</label>
                    <div className="relative">
                      <md-icon className="absolute left-3 top-1/2 -translate-y-1/2 text-blue-600 text-lg">location_on</md-icon>
                      <input
                        type="text"
                        name="origen"
                  ...
                  <div>
                    <label className="text-xs font-semibold text-gray-700 mb-1.5 block uppercase tracking-wide">Destino</label>
                    <div className="relative">
                      <md-icon className="absolute left-3 top-1/2 -translate-y-1/2 text-blue-600 text-lg">flag</md-icon>
                      <input
                        type="text"
                        name="destino"
                  ...
                  <div>
                    <label className="text-xs font-semibold text-gray-700 mb-1.5 block uppercase tracking-wide">Fecha de viaje</label>
                    ...
                    <div className="relative">
                      <md-icon className="absolute left-3 top-1/2 -translate-y-1/2 text-blue-600 text-lg">event</md-icon>
                      <input
                        type="date"
                        name="fecha"
            ...
            <div className="md:col-span-3 text-white space-y-6 md:pl-12">
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-black leading-tight">
                Viajar está a un<br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">clic de distancia</span>
              </h1>

              <p className="text-xl md:text-2xl text-gray-300 font-light max-w-2xl">Compra tus tiquetes de forma rápida, segura y sin complicaciones</p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="space-y-6">
              ...
              <h3 className="text-4xl md:text-5xl font-black text-gray-900 leading-tight">Más de 20 años conectando destinos</h3>
              <p className="text-gray-600 text-lg leading-relaxed">En <span className="font-bold text-blue-600">La Tribu</span>, somos más que una empresa de transporte. Somos tu compañero de viaje, comprometidos con llevar a cada pasajero de manera segura, cómoda y puntual.</p>
              ...
              <div className="grid grid-cols-3 gap-6 pt-6">
                {[{ num: "500K+", label: "Pasajeros" }, { num: "50+", label: "Destinos" }, { num: "99%", label: "Satisfacción" }].map((stat, i) => (
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl p-12 shadow-xl">
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
              {[{ num: "4.8/5", label: "Calificación" }, { num: "500K+", label: "Pasajeros/año" }, { num: "98%", label: "Puntualidad" }, { num: "50+", label: "Destinos" }].map((stat, i) => (
                <div key={i}>
      ...
      <footer id="contacto" className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 md:px-16">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center font-black text-xl mb-4">LT</div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                {["Inicio", "Nosotros", "Destinos", "Beneficios"].map((link) => (
                  <li key={link} onClick={() => scrollToSection(link.toLowerCase())} className="hover:text-white cursor-pointer transition-colors">{link}</li>
                ))}
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li className="flex items-center gap-2"><md-icon className="text-blue-400 text-lg">phone</md-icon>+57 300 123 4567</li>
                <li className="flex items-center gap-2"><md-icon className="text-blue-400 text-lg">email</md-icon>info@latribu.com</li>
                <li className="flex items-center gap-2"><md-icon className="text-blue-400 text-lg">location_on</md-icon>Medellín, Colombia</li>
              </ul>
            </div>
          </div>

          <div className="border-t border-gray-800 pt-6 text-center">
            <p className="text-gray-500 text-sm">© 2025 La Tribu. Todos los derechos reservados.</p>
          </div>
        </div>
      </footer>
    </div>
