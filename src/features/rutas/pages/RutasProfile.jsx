    ...
    return (
        <div className={`flex flex-col gap-4 overflow-auto ${isClosing ? 'profile-exit' : 'profile-enter'}`}
            ...
            <div className='bg-primary text-on-primary content-box-small'>
                <h1 className='h3 text-on-primary'>{ruta.nombre}</h1>
                <span className='subtitle1 font-medium text-on-primary'>{ruta.codigo}</span>
            </div>

            <div className="flex flex-col gap-3 flex-1">
                <div className="flex flex-col">
                    <div className="content-box-outline-3-small">
                        <span className="subtitle1 text-primary font-light">Estado de la ruta</span>
                        <div className='flex mt-1'>
                            <button className={`btn font-medium btn-lg flex items-center ${ruta.estado === 'Activa' ? 'btn-primary' : 'btn-secondary'}`}>
                                {ruta.estado}
                            </button>
                        </div>
                    </div>
