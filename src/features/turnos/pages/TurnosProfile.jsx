...
const TurnosProfile = ({ vehicle, isOpen, onClose }) => {
        ...
        <div className={`flex flex-col gap-4 overflow-auto ${isClosing ? 'profile-exit' : 'profile-enter'}`}
            ...
            <div className='flex justify-between items-center'>
                <div className='flex items-center gap-1'>
                    ...
                    <h2 className='h4 font-medium text-white'>Detalle del turno</h2>
                </div>
            ...
            <div className='bg-primary text-on-primary content-box-small'>
                <h1 className='h3 text-on-primary'>{vehicle.conductor}</h1>
                <span className='subtitle1 font-medium text-on-primary'>Vehículo: {vehicle.vehiculo}</span>
            </div>

            <div className="flex flex-col gap-3 flex-1">
                <div className="flex flex-col">
                    <div className="content-box-outline-3-small">
                        <span className="subtitle1 text-primary font-light">Estado del turno</span>
