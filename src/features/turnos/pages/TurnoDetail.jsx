        ...
        <section className="list-enter">
            ...
            <div className="flex gap-4 mb-6">
                ...
                <button
                    ...
                    className="btn btn-secondary btn-lg font-medium flex items-center"
                >
                    <md-icon slot="icon" className="text-sm">assignment</md-icon>
                    Asignar turno
                </button>
                <button
                ...
                >
                    <md-icon slot="icon" className="text-sm">delete</md-icon>
                    Eliminar turno
                </button>
            </div>
            ...
            <div className="content-box-outline-4">
                ...
                <div className="mb-6">
                    ...
                    <button className={`btn btn-lg font-medium ${getEstadoBadgeClass(raw.estado || turno.estado)}`}>
                ...
                <div className="border-t border-outline pt-6">
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        <div>
                            <label className="subtitle2 text-secondary block mb-1">Fecha</label>
                            <p className="body1">{formatFecha(raw.fecha || turno.fecha)}</p>
                        </div>
                        <div>
                            <label className="subtitle2 text-secondary block mb-1">Hora</label>
                            <p className="body1">{raw.hora || turno.hora}</p>
                        </div>
                        <div>
                            <label className="subtitle2 text-secondary block mb-1">Vehículo</label>
                            <p className="body1">
                                {raw.vehiculo 
                        ...
                        <div>
                            <label className="subtitle2 text-secondary block mb-1">Conductor</label>
                            <p className="body1">
                                {raw.conductor 
                                    ? `${raw.conductor.nombre} ${raw.conductor.apellido}` 
                                    : turno.conductor}
                        ...
                        {raw.conductor?.cedula && (
                            <div>
                                <label className="subtitle2 text-secondary block mb-1">Cédula del conductor</label>
                                <p className="body1">{raw.conductor.cedula}</p>
                            </div>
                        )}
                        {raw.conductor?.telefono && (
                            <div>
                                <label className="subtitle2 text-secondary block mb-1">Teléfono del conductor</label>
